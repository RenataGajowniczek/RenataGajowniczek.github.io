function stickyNavDirective(e, t, i) {
    function n(n, s, c) {
        ...
        function a(i) {
            isNaN(+i) && (i = c.maxTries || 0), i >= 0 && t(function () {
                var t = s[0].getBoundingClientRect().top + e.pageYOffset, n = s[0].clientHeight;
                t > 0 || n > 0 ? (f = t, r = n) : a(i - 1)
            }, c.msRetryDelay || 100)
        }

        var l = angular.element(e), r = 0, f = 0, u = "ng-sticky-fixed", d = c.stickyNav || u, g = "undefined" != typeof c.ignoreElementSize;
        !function () {
            a(), n.$watch(function () {
    ...
    return {scope: {}, restrict: "A", link: n}
}
